...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        current_weather_file_name = f"weather/RT-CurrentAPI/city={city_name}/date={current_datet}/{city_name}_current_weather_{current_datetime}.json"
        ...
        forecast_file_name = f"weather/RT-3HrForecastAPI/city={city_name}/date={current_datet}/{city_name}_three_hour_forecast_{current_datetime}.json"
        ...
        air_pollution_file_name = f"pollution/city={city_name}/date={current_datet}/{city_name}_air_pollution_{current_datetime}.json"
